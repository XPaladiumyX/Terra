...
Config packs updated for the 26.1.2 block set are published as **assets of the
[GitHub releases](https://github.com/XPaladiumyX/Terra/releases)** of this repository.
...
| Pack | What was fixed |
| --- | --- |
| Origen 2.2.0 | addon id `biome-provider-pipeline-v2` → `biome-provider-pipeline`, `chain` → `iron_chain`, `grass` → `short_grass` |
| ReimagEND 2.3.7 | same fixes (addon id, chain, grass) |
